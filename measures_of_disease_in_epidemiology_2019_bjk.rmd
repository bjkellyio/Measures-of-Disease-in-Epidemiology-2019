...
## Imaginary Study of _Pneumocystis_   Among Patients with AIDS <hr/>
...
tibble(subject_id = factor(seq(50)),
  ...
  theme_classic() +
  theme(text = element_text(size = 22), axis.text.y = element_text(size = 12)) -> p

```


```{r pcp_point_prev, ref.label = "pcp_study", echo=FALSE, warning=FALSE, message=FALSE, fig.height=6, fig.width=12, fig.align='center', fig.retina=2}
