...
p + geom_vline(aes(xintercept = 0.9), colour = "purple", size = 3, alpha = 0.4)
...
p + geom_point(aes(x = 0, y = subject_id), colour = "green", size = 3, alpha = 0.2) +
...
- number needed to treat (NNT): number of patients who need to be treated for one person to benefit from the treatment  (= 1/RD)
    ...
    - using RD numbers above, NNT = 1/RD = 1/0.1 = 10 (treat 10 people to prevent one bad outcome)
...
$$OR = \frac{\frac{A}{C}}{\frac{C}{D}} = \frac{A*D}{B*C}$$  
]
