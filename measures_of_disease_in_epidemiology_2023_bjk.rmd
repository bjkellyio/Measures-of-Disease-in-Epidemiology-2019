...
## HIV Beginnings: MMWR June 5, 1981
...
## HIV Beginnings: Stigma & Discrimination  
...
- As we proceed in course, think about causal and proxy variables.  
...
- Some ways social determinants and racism impact health:  
...
<div class="extension-tile gridset-grey"><div>Prevalence</div></div>
<div class="extension-tile gridset-grey"><div>Incidence</div></div>
<div class="extension-tile gridset-d animated flipInX"><div>Aggregate vs<br>Conditional Risk</div></div>
<div class="extension-tile gridset-grey"><div>Relative Risk<br>&<br>Odds Ratios</div></div>
<div class="extension-tile gridset-grey"><div>Data Types<br>&<br>Distributions</div></div>
</div>
...
- Just as you can always calculate RR from a 2x2 table, but sometimes you shouldn't, you can always calculate mean and SD from continuous data. The question is whether you should.  
