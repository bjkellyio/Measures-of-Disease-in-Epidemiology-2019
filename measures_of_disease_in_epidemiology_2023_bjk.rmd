...
NHANES |> 
  ...
  labs(title = "Parametric Data", subtitle = "CDC National Health and Nutrition Examination Survey (NHANES)", x = "BMI (kg/m2)", y = "Subject Count") +
  facet_wrap(facets = ~ Gender)

```

.footnote[[*] https://www.cdc.gov/nchs/nhanes/index.htm]
...
.pad-left[
- See the diagnosis lecture: threshold of oxygen saturation (or $\beta$-D glucan) to diagnose _Pneumocystis_ pneumonia (PCP) means trade-off between sensitivity and specificity.
...
![CDC [MMWR](https://www.hiv.gov/hiv-basics/overview/history/hiv-and-aids-timeline)](figs/hiv_timeline_mmwr_1981.png)
...
![Radiolab: https://radiolab.org/podcast/ashes-lawn.](img/radiolab_ashes_on_the_lawn_tall.png)
...
<div class="extension-tile gridset-grey"><div>Prevalence</div></div>
<div class="extension-tile gridset-grey"><div>Incidence</div></div>
<div class="extension-tile gridset-e animated flipInY"><div>Aggregate vs<br>Conditional Risk</div></div>
<div class="extension-tile gridset-grey"><div>Relative Risk<br>&<br>Odds Ratios</div></div>
</div>
